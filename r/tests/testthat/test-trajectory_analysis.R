...
test_that("runGenerateTrajectoryGraph output has the expected list format", {
  data <- mock_scdata()
  req <- mock_req(data)
...
test_that("output generated by runGenerateTrajectoryGraph has the correct number of nodes", {
  data <- mock_scdata()
  mock_embedding_data <- get_mock_embedding_data(data)
  mock_embedding_settings <- get_mock_embedding_settings()
  mock_clustering_settings <- get_mock_clustering_settings()
